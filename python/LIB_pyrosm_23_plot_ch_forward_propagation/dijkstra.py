...
class HandlerWantsToStopPropagation(Exception):
    """ This exception must be raised by handler if he wants to stop propagation. """
    pass
...
class Dijkstra:
    ...
    NO_TARGET = "NO_TARGET"  # sentinel if we don't want to stop dijkstra once a specific target is settled
