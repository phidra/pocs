...
// this is pasted from : https://github.com/phidra/RoutingKit/blob/a0776b234ac6e86d4255952ef60a6a9bf8d88f02/src/contraction_hierarchy.cpp#L1712
...
void unpack_forward_arc(const RoutingKit::ContractionHierarchy&ch, unsigned arc, const OnNewInputArc&on_new_input_arc);

template<class OnNewInputArc>
void unpack_backward_arc(const RoutingKit::ContractionHierarchy&ch, unsigned arc, const OnNewInputArc&on_new_input_arc);
