...
DEFAULT_OUTPUT_DIR="/tmp/propagation21/"
...
DESCRIPTION = plotting dijkstra propagation (including hull) + nb of settled nodes

This POC plots the propagation of dijkstra algorithm, in order to produce a video.
...
Compared to the previous POC, this one aims to a better (and more separated) code.
