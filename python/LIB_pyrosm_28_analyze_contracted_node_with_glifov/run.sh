...
DEFAULT_OUTPUT_DIR="/tmp/propagation28/"
...
DESCRIPTION = plot CH inforamtion about a given

Compared to similar POC 18, this POC uses external project GLIFOV.

(this GLIFOV project is the project that handles graph / CH / drawing related things)
