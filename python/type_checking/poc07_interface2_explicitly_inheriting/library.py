...
# NOTE 1 : when compare to the first POC, there is an explicit HandlerInterface here :
...
@dataclass
class PrinterHandler(HandlerInterface):  # implements HandlerInterface
...
@dataclass
class DummyHandler(HandlerInterface):  # implements HandlerInterface
...
# NOTE 2 : when compare to the first POC, the typing of 'handler' has changed, it now uses our 'HandlerInterface'
# The goal is for mypy to be able to recognize our MyCustomHandler as a HandlerInterface child.
