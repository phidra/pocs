...
DEFAULT_OUTPUT_DIR="/tmp/propagation31/"
...
DESCRIPTION = plot the whole graph at different level of hierarchy

The objective is to show that graph is simpler and simpler the more we advance in hierarchy.
...
echo ""
echo "=== RUNNING"
MONACO_POLYGON="${this_script_parent}/drawing_bbox.geojson"
