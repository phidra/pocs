...
WARNING : this POC does not bring definitive conclusions !

In this POC, the graph is totally bidirectional, which makes the understanding of what is happening somewhat confusing.
(for instance, getting the middle-node/unpacking of a shortcut might be difficult...)

A future POC will focus on a non-bidirectional graph.
