...
cat << EOF
Cette POC utilise le code d'un exemple fourni avec libosmium :
    https://github.com/osmcode/libosmium/blob/6c1ade0205045297124b03684c261240ee9b78e4/examples/osmium_count.cpp

Il compte les nodes/ways/relations dans un fichier OSM.
