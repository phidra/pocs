...
int main() {
    ...
    cout << "Index with " << point_cloud_size << " points was construction in " << construction_time << " musec"
         << endl;
    ...
    for (float radius : test_radii) {
        ...
        cout << "of " << query_count << " queries there were " << non_trivial_count
             << " queries with a non-trivial answer" << endl;
    ...
    for (float radius : test_radii) {
        ...
        cout << query_count << " queries were answered in " << query_time << " musec with radius " << radius << " m"
             << endl;
        cout << "per query running time : " << (double)query_time / (double)query_count << "musec" << endl;
