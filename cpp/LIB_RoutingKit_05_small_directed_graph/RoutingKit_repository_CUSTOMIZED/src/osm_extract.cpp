...
int main(int argc, char* argv[]) {
    try {
        std::string pbf_file, first_out_file, head_file, geo_distance_file, travel_time_file, way_file, way_speed_file,
            way_name_file, latitude_file, longitude_file, osm_node_file, osm_way_file;
        ...
        if (argc == 13) {
            ...
            cout << "Usage:" << endl;
            cout << argv[0]
                 << " pbf_file first_out head geo_distance travel_time way way_speed way_name latitude longitude "
                    "osm_node osm_way"
                 << endl;
