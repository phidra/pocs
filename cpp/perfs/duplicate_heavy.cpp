...
int main(int argc, char* argv[]) {
    ...
    cout << "call 1 took  : " << chrono::duration_cast<chrono::milliseconds>(time_point_2 - time_point_1).count()
         << " ms" << endl;
    heavy_function(12 * 1000 * 1000);
    auto time_point_3 = chrono::steady_clock::now();
    cout << "call 2 took  : " << chrono::duration_cast<chrono::milliseconds>(time_point_3 - time_point_2).count()
         << " ms" << endl;
}
