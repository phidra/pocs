...
int main(int argc, char* argv[])
{
    ...
    cout << "light took  : " << chrono::duration_cast<chrono::milliseconds>(time_point_2-time_point_1).count() << " ms" << endl;
    medium_function();
    auto time_point_3 = chrono::steady_clock::now();
    cout << "medium took : " << chrono::duration_cast<chrono::milliseconds>(time_point_3-time_point_2).count() << " ms" << endl;
    heavy_function();
    auto time_point_4 = chrono::steady_clock::now();
    cout << "heavy took  : " << chrono::duration_cast<chrono::milliseconds>(time_point_4-time_point_3).count() << " ms" << endl;
}
...
void heavy_function() { compute(10*1000*1000); }
void medium_function() { compute(1000*1000); }
void light_function() { compute(100*1000); }
