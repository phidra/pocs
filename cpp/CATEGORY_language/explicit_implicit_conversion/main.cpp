...
// La fonction f n'accepte que des Implicit, pourtant on peut lui passer des ints : le compilo convertit implicitement
// l'int en Implicit Par ailleurs, on peut utiliser la copy initialization (alors qu'avec un Explicit, ça ne marche
// pas).
...
int main(int argc, char* argv[]) {
    // f attend un Implicit, on peut donc lui passer un int : comme il existe un constructeur de conversion de int vers
    // Implicit, ça compile :
    f(50);
