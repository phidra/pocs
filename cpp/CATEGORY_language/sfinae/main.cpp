...
struct A1 { int get_value() const { return 42; } };
struct A2 { int get_value() const { return 142; } };
struct A3 { int get_value() const { return 1142; } };
struct B1 { int get_the_content() const { return 10; } };
struct B2 { int get_the_content() const { return 100; } };
struct B3 { int get_the_content() const { return 1000; } };
...
// Here, SFINAE is :
//  - the first templated-definition will statically fail on a B* type (because B has no "get_value" member, which is used on template-definition)
