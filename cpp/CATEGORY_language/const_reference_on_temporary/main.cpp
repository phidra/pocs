...
A f() { A var = A{}; return var; }  // cette fonction se contente de renvoyer une variable temporaire
...
{
    {
        ...
        // En revanche, la ligne ci-dessous compile, et ÉTEND LA PORTÉE DE LA VARIABLE TEMPORAIRE jusqu'à la fin du scope !
        const A& var1 = f();
