...
// À noter qu'on peut utiliser les membres (et méthodes) statiques d'une classe même sans qu'elle soit jamais
// instanciée. Pour initialiser un membre statique, tout se passe comme si on le déclarait une seconde fois. See:
// https://blog.tartanllama.xyz/initialization-is-bonkers/#fnref:1
