...
struct Stop {
    ...
    enum WHEELCHAIR_BOARDING : uint8_t { NO_INFORMATION = 0, BOARDING_POSSIBLE = 1, BOARDING_NOT_POSSIBLE = 2 };

    std::string id, code, name, desc, zone_id, stop_url, stop_timezone, platform_code, parent_station;
    float lat, lng;
