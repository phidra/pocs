...
int main() {
...

    {
        ...
        char const *begin = buf, *end = buf + sizeof(buf);
    ...
    {
        char buf[] = {(char)138, (char)168, (char)17,  (char)220, (char)254, (char)219, (char)195,
                      (char)2,   (char)199, (char)254, (char)219, (char)195, (char)2,   (char)180,
                      (char)179, (char)169, (char)134, (char)10,  (char)141, (char)229, (char)205,
                      (char)194, (char)7,   (char)167, (char)206, (char)219, (char)195, (char)2};
        char const *begin = buf, *end = buf + sizeof(buf);
        ...
        char const* val_begin[] = {buf + 0, buf + 3, buf + 8, buf + 13, buf + 18, buf + 23};
...

    {
        ...
        decode_protobuf_message_with_callbacks(
            ...
            [](uint64_t id, uint64_t num) { EXPECT(false); },
            [](uint64_t id, double num) { EXPECT(false); },
            [&](uint64_t id, char const* begin, char const* end) {
                EXPECT_CMP(id, ==, 2);
