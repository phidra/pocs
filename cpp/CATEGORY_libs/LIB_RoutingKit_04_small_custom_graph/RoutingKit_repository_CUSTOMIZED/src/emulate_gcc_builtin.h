...
namespace detail {
inline unsigned emulated_builtin_popcountll(unsigned long long x) {
    int n = 0;
...
inline unsigned emulated_builtin_popcount(unsigned x) {
    return emulated_builtin_popcountll(x);
}

inline unsigned emulated_builtin_ffsll(unsigned long long x) {
    int n = 1;
