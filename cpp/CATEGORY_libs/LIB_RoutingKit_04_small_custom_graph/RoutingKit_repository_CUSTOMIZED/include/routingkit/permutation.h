...
//
//  Applying a permutation p to the elements of a vector v consists of computing the vector {p[v[0]], p[v[1]], p[v[2]],
//  ... , p[v[n]]}
//
...
inline std::vector<unsigned> identity_permutation(unsigned n) {
